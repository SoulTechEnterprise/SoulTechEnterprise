...
- Plataformas digitais B2B  
- Automação de processos  
- Consultoria técnica e arquitetura de software  

## Modelo de atuação

- Desenvolvimento por projeto ou fases  
- Contratos recorrentes de evolução e sustentação  
- Consultoria técnica  
...
Empresa incubada no **Tec Unimar**, com apoio da **Universidade de Marília (UNIMAR)**.
